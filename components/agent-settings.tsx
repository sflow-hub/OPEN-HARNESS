...
import { Check, ChevronDown, Cpu, FileText, LoaderCircle, Plus, RefreshCw, Search, SlidersHorizontal, Trash2, UserRound, X, Cable, MonitorCog, Server, Folder, Copy, CircleStop, FolderKanban } from 'lucide-react';
...
type Props = { agent: Agent; client: ControlClient; onClose: () => void; onSaved: (profile: AgentProfile) => void; initialTab?: Tab; onManageCredentials?: () => void };
...
export default function AgentSettings({ agent, client, onClose, onSaved, initialTab = 'profile', onManageCredentials }: Props) {

...
export function validateProfile(value: AgentProfile): AgentProfile {
  ...
  const board = value.board || { assignOthers: false, dispatch: false };
  if (typeof board.assignOthers !== 'boolean' || typeof board.dispatch !== 'boolean') throw new ProfileError('Invalid board permissions.');

...
Open Harness is pre-1.0 (currently `0.3.0`). This document tracks feature
...
| Self-hosted Docker Compose stack | Functional; hardening (container capabilities, healthchecks) is ongoing. |
